...
describe 'fizzbuzz' do
  ...
  it "should test for indivisibilty by 5" do
  ...
  it "should return fizzbuzz when given a multiple of 3 & 5" do
    expect(fizzbuzz(15)).to eq "Fizzbuzz"
  end

  it "should return number if number is neither a multiple of 3 or 5" do
