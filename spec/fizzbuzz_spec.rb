...
describe 'fizzbuzz' do
  ...
  it "should return number when given a number that is neither a multiple of 3 or 5" do
    expect(fizzbuzz(2)).to eq 2
  end

  it "should return number when given number that is neither a multple if 3 or 5" do
